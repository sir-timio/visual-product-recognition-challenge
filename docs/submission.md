...
```bash
cd visual-product-recognition-2023-starter-kit

# Add AIcrowd git remote endpoint
git remote add aicrowd git@gitlab.aicrowd.com:<YOUR_AICROWD_USER_NAME>/visual-product-recognition-2023-starter-kit.git 
...
`https://gitlab.aicrowd.com/<YOUR_AICROWD_USER_NAME>/visual-product-recognition-2023-starter-kit/issues`
