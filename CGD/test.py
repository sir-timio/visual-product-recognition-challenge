...
if __name__ == '__main__':
    ...
    parser.add_argument('--query_img_name', default='rand', type=str,
                        help='query image name')
    parser.add_argument('--data_base', default='isc_uncropped_resnext50_GS_512_0.1_0.5_0.1_256_data_base.pth',
    ...
    result_path = 'results_test/{}'.format(query_img_name.split('/')[-1].split('.')[0])
